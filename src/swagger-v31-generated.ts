 ...
 * swagger-v3.1.json. DO NOT MODIFY IT BY HAND — genuine, unedited
 * generation output, same discipline as swagger-v3-generated.ts (see
 * src/swagger-v3-generation-notes.md for why that split exists). Instead,
 * modify swagger-v3.1.json and run `npm run generate:swagger-v31-base` to
 * regenerate this file (this will also overwrite this banner comment —
 * expected, the durable documentation lives in
 * swagger-v31-generation-notes.md, not here).
 *
 * These are the raw OpenAPI 3.1 types with no Atlassian-specific
 * extensions. src/swagger-v31.ts composes this file into the public
 * `SwaggerV31` namespace — see swagger-v31-generation-notes.md for the
 * full, itemized list of how and why they differ.
 */

/**
 * This interface was referenced by `SwaggerV31`'s JSON-Schema
...
export interface SwaggerV31 {
  ...
  /**
   * This interface was referenced by `SwaggerV31`'s JSON-Schema definition
